  ...
  return (
    <div className="app">
      <div className="app-container flex flex-col items-center justify-center">
        ...
        <button
          className="bg-green-500 rounded-md p-2 text-white border-none hover:bg-green-300 cursor-pointer"
        ...
        {posts.map((post) => (
          <div className="post bg-gray-300 w-[900px] p-2 my-2 rounded-md" key={post.id}>
            ...
            <button
              className="button bg-blue-500 rounded-md p-2 text-white border-none hover:bg-blue-300 cursor-pointer m-1"
              onClick={() => handleUpdatePost(post.id)}
            >
              Update
            </button>
            <button
              className="button bg-red-500 rounded-md p-2 text-white border-none hover:bg-red-300 cursor-pointer m-1"
